<!-- Jumbotron -->
<div class="relative ml-14 bg-center overflow-hidden rounded-lg bg-cover bg-no-repeat p-12 text-center"
    ...
    <div class=" absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"
        ...
        <div class=" flex h-full items-center justify-center">
            <div class="text-white">
                <h2 class="mb-4 text-4xl font-semibold">Mohamad khadik</h2>
                <h4 class="mb-6 text-xl font-semibold">Development</h4>
                <button type="button"
