...
<!-- component -->
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <ul
            ...
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500 {{ ($title === "Home") ? 'active': 'text-gray-800'}}" href="/">Home</a></li>
            ...
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500 {{ ($title === "Kost") ? 'active': 'text-gray-800'}}" href="/kost">Kost</a></li>
            <li class="text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                    class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li><a class="text-sm text-blue-600 font-bold hover:text-gray-500 {{ ($title === "Contact") ? 'active': 'text-gray-800'}}" href="/contact">Contact</a></li>
        </ul>
            ...
            <div>
                <ul>
                    <li class="mb-1">
                        ...
                        {{ ($title === "Home") ? 'active': 'text-gray-800'}}" href="/">Home</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded
                        {{ ($title === "About") ? 'active': 'text-gray-800'}}" href="/kost">Kost</a>
                    </li>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded
                        {{ ($title === "Contact") ? 'active': 'text-gray-800'}}" href="/contact">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="mt-auto">
